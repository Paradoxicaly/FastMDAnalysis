...
def test_cli_analyze_slides_with_custom_output_dir(tmp_path: Path, dataset_paths):
    """Test CLI with --slides respects custom output directory specified via -o."""
    ...
    # Expected behavior: slide deck should be in the custom output directory
    ...
    # Verify analysis outputs are also in the custom directory
